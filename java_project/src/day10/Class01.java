...
public class Class01 {
	 ...
	 * - 하나의 java 파일 안에 하나의 클래스만 있을 수 있는건 아님.
	 * - 멤버 변수와 맴버 메서드 public 문제없이 사용 가능.
	 * - 일반적으로 멤버변수는 private, 메서드는 public으로 선언한다.
	 * - private : 다른 클래스에서 접근(사용)할 수 없음.
...
class Point{
	...
	// 포인트 값을 저장하는 메서드
	public void save(int x, int y) { // 지역변수는 갈색
		// this : 멤버변수를 지칭하는 키워드
		this.x = x;
		this.y = y;
	}
