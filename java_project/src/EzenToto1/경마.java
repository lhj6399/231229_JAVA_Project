...
public class 경마 {
	...
	public void add(Scanner scan) {
		...
		case 2:
			...
			System.out.println("========마번===마   명=====습 성===우승 확률===========");
			System.out.println("	 ①  [스페셜 위크] [ 도주 ]  [30%]"); 
			System.out.println("	 ②  [키타산 블랙] [ 선행 ]  [20%]");
			System.out.println(" 	 ③  [큐피드 보이] [ 추입 ]  [ 7%]");
			System.out.println(" 	 ④  [하루 우라라] [ 도주 ]  [ 3%]"); 
			System.out.println("  	 ⑤  [블랙 포인트] [ 선입 ]  [15%]");
			System.out.println(" 	 ⑥  [매지로 맥퀸] [ 후행 ]  [25%]"); 
			System.out.println("=================================================");
			break;
